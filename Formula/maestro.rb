"https://github.com/jexia/maestro/releases/download/v2.0.0-beta.14/maestro-2.0.0-beta.14-linux-arm.tar.gz" sha256 "dc144be4fbb7294bfa8274345d64b4d756ca5376f5860295ad96fdad763a6535" end end end def install bin.install "maestro" end test do system "#{bin}/maestro -v" end end
